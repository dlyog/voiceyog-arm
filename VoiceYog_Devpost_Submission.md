...
[![Can KleidiAI make it faster? A measured no — 2 min 47 s](https://raw.githubusercontent.com/dlyog/voiceyog-arm/main/.github/kleidiai-thumbnail.png)](https://youtu.be/r2mlrF9LK4E)

**There is a 2 minute 47 second video of this: [youtu.be/r2mlrF9LK4E](https://youtu.be/r2mlrF9LK4E)**. It shows KleidiAI being installed and its kernels called directly, one returning and one dying, and then the 2x thread-placement result. Every terminal frame in it is real captured output; nothing was screen-recorded or typed for the camera, and the narration is my own cloned voice running locally on the DGX Spark.
